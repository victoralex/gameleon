...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:site="http://site.emotionconcept.ro" version="1.0">
	...
	<xsl:include href="../../components/rssFeedFront/rssFeedFront.xsl"/>
	<xsl:include href="../../components/componentsListFront/componentsListFront.xsl"/>
	
	<!-- Widgets Includes -->
	<xsl:include href="../../widgets/richText/richText.xsl"/>
	<xsl:include href="../../components/footerCopyright/footerCopyright.xsl"/><xsl:include href="../../components/content/content.xsl"/><xsl:include href="../../widgets/button/button.xsl"/>
	...
	<xsl:variable name="translation" select="document(concat($configuration/siteProtocol, '://', $configuration/siteURL/text(), '/pages/contentManagement/configuration/translations/contentManagement.', //application/@lang, '.xml'))/translation"/>
