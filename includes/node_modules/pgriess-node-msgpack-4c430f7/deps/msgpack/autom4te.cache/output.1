...
for ac_header in tr1/unordered_set
do :
  ac_fn_cxx_check_header_mongrel "$LINENO" "tr1/unordered_set" "ac_cv_header_tr1_unordered_set" "$ac_includes_default"
if test "x$ac_cv_header_tr1_unordered_set" = xyes; then :
  cat >>confdefs.h <<_ACEOF
...
{ $as_echo "$as_me:${as_lineno-$LINENO}: checking for __sync_* atomic operations" >&5
$as_echo_n "checking for __sync_* atomic operations... " >&6; }
if ${msgpack_cv_atomic_ops+:} false; then :
  $as_echo_n "(cached) " >&6
else
...
{ $as_echo "$as_me:${as_lineno-$LINENO}: result: $msgpack_cv_atomic_ops" >&5
$as_echo "$msgpack_cv_atomic_ops" >&6; }
if test "$msgpack_cv_atomic_ops" != "yes"; then
	as_fn_error $? "__sync_* atomic operations are not supported.
