...
define( 'FPDF_FONTPATH', SystemConfig::$installDir . DIRECTORY_SEPARATOR . "includes" . DIRECTORY_SEPARATOR . "classes" . DIRECTORY_SEPARATOR . "class.fpdf.php_files" . DIRECTORY_SEPARATOR );
