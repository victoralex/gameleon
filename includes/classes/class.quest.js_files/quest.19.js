	...
	{ 
		...
		this.conditions['q19TalkedToWarlord'] = new questCondition({parameterName:'q19TalkedToWarlord', targetValue:1, quest: self, questServer: args.questServer});
