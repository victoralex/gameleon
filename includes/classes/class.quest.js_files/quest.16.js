	...
	{ 
		...
		this.conditions['q16targetDummiesDamaged'] = new questCondition({parameterName:'q16targetDummiesDamaged', targetValue:3, quest: self, questServer: args.questServer});
