	...
	{ 
		...
		this.conditions['q45_1a'] = new questCondition({parameterName:'q45_1a', targetValue:1, quest: self, questServer: args.questServer});this.conditions['q45_2b'] = new questCondition({parameterName:'q45_2b', targetValue:2, quest: self, questServer: args.questServer});this.conditions['q45_3c'] = new questCondition({parameterName:'q45_3c', targetValue:3, quest: self, questServer: args.questServer});
