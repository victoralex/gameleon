	...
	{ 
		...
		this.conditions['q10PurchasedItems'] = new questCondition({parameterName:'q10PurchasedItems', targetValue:1, quest: self, questServer: args.questServer});
