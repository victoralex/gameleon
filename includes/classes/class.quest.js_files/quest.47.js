	...
	//
	// Wake Up And Smell The Breeze! ( 47 )
	//
	...
	{ 
		...
		this.conditions['q47_1Gearpickedupfromchest'] = new questCondition({parameterName:'q47_1Gearpickedupfromchest', targetValue:1, quest: self, questServer: args.questServer});
