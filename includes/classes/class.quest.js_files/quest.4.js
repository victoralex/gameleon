	...
	{ 
		...
		this.conditions['kills'] = new questCondition({parameterName:'kills', targetValue:10, quest: self, questServer: args.questServer});this.conditions['squirrelKills'] = new questCondition({parameterName:'squirrelKills', targetValue:5, quest: self, questServer: args.questServer});
