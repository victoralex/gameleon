	...
	{ 
		...
		this.conditions['a2_1Dances'] = new achievementCondition({parameterName:'a2_1Dances', targetValue:2, achievement: self, achievementServer: args.achievementServer});this.conditions['a2_2Yells'] = new achievementCondition({parameterName:'a2_2Yells', targetValue:3, achievement: self, achievementServer: args.achievementServer});
