	...
	//
	// Get Your Nose Outta Our Business! ( 10 )
	//
	...
	{ 
		...
		this.conditions['q10_1KilltheBrightStrandHegemonySpyLeader'] = new achievementCondition({parameterName:'q10_1KilltheBrightStrandHegemonySpyLeader', targetValue:1, achievement: self, achievementServer: args.achievementServer});
