	...
	{ 
		...
		this.conditions['a1_1BarrelRolls'] = new achievementCondition({parameterName:'a1_1BarrelRolls', targetValue:1, achievement: self, achievementServer: args.achievementServer});
