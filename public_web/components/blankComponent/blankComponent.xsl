...
<xsl:output method="html" encoding="UTF-8" indent="yes"/>
	...
	<xsl:variable name="blankComponentClientConfig" select="document(concat('/pages/', //application/values/get/@page, '/configuration/components/blankComponent/client/configuration.xml'))/configuration" />
	
	<!-- General Template -->
	<xsl:template name="blankComponent" match="component:blankComponent">
	    
		<div class="component blankComponent" id="{generate-id()}">
