...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:site="http://site.emotionconcept.ro" version="1.0">
	...
	<xsl:variable name="translation" select="document(concat($configuration/siteProtocol, '://', $configuration/siteURL/text(), '/pages/selectCharacter/configuration/translations/selectCharacter.', //application/@lang, '.xml'))/translation"/>
